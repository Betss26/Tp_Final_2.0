<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EstudianteCrear.aspx.cs" Inherits="Final_Master_Page.EstudianteCrear" %>
     ...
     <div class="col-md">
         ...
         <div class="row g-3">
             <div class="col">
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidatorNumDoc" runat="server" ErrorMessage="El numero de documento es obligatorio" ControlToValidate="txt_numDoc" class="text-danger"></asp:RequiredFieldValidator>
         ...
         <div class="row g-3">
             <div class="col">
                 ...
                 <asp:TextBox ID="txt_usuario" CssClass="form-control" placeholder="Ingrese email como usuario" runat="server"></asp:TextBox>
             </div>
         </div>
         <div class="row g-3">
             <div class="col">
     ...
     <div class="col-md">
         ...
         <div class="row g-3">
             <div class="col">
                 ...
                 <asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                     ...
                     class="text-danger" />
                 <asp:TextBox ID="txt_estado" CssClass="form-control" placeholder="Ingrese estado" runat="server"></asp:TextBox>
             </div>
         </div>
         <div class="row g-3">
             <div class="col">
         ...
         <div class="row g-3">
             <div class="col">
                 ...
                 <asp:Button ID="btn_crear_estudiante" runat="server" Text="crear" OnClick="btn_crear_estudiante_Click" CssClass="btn btn-primary" />
